...
<li class="{{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}">
    <a href="javascript: void(0);" class="has-arrow {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}">
        <i data-feather="book"></i>
        <span data-key="t-multi-level">Pembiayaan</span>
    </a>
    <ul class="sub-menu {{ request()->is('*data/pembiayaan*') ? 'mm-collapse mm-show' : '' }}" aria-expanded="true">
        <li {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}>
            <a href="{{ route('data.pembiayaan.pembukaan') }}" {{ request()->is('*data/pembiayaan/pembukaan*') ? 'active' : '' }}>
                <span data-key="t-calendar">Pembukaan</span>
            </a>
        </li>
        <li {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}>
            <a href="{{ route('data.pembiayaan.setoran') }}" {{ request()->is('*data/pembiayaan/setoran*') ? 'active' : '' }}>
                <span data-key="t-calendar">Setoran</span>
            </a>
        </li>
        <li {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}>
            <a href="{{ route('data.pembiayaan.mutasi') }}" {{ request()->is('*data/pembiayaan/mutasi*') ? 'active' : '' }}>
                <span data-key="t-calendar">Mutasi</span>
            </a>
        </li>
        <li {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}>
            <a href="{{ route('data.pembiayaan.pelunasan-awal') }}" {{ request()->is('*data/pembiayaan/pelunasan-awal*') ? 'active' : '' }}>

                <span data-key="t-calendar">Pelunasan Awal</span>
            </a>
        </li>
    </ul>
</li>
<li class="{{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}">
    <a href="javascript: void(0);" class="has-arrow {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}">
        ...
        <span data-key="t-multi-level">Pembayaran Jasa</span>
    </a>
    <ul class="sub-menu {{ request()->is('*data/pembiayaan*') ? 'mm-collapse mm-show' : '' }}" aria-expanded="true">
        <li {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}>
            <a href="#" {{ request()->is('*data/shu*') ? 'active' : '' }}>
                <span data-key="t-calendar">Pembukaan</span>
            </a>
        </li>
        <li {{ request()->is('*data/pembiayaan*') ? 'mm-active' : '' }}>
