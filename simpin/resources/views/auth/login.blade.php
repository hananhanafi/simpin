                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('assets') }}/images/logo_damar.jpeg" alt=""
                                            height="40">
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">Menggunakan akun anda.</p>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="mt-4 pt-2">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Enter username" value="{{ old('email') }}" name="email">
                                            @error('email')
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">
                                        ...
                                        </script> © PT Mulia Industrindo - Manajemen Sumber
                                        Dana
                                        {{-- {{ config('app.name') }} . Crafted with <i
