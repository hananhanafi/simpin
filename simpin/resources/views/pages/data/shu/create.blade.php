            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('data.shu.index') }}" class="btn btn-info btn-sm" style="float: right"><i
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="file" class="form-control" name="file" id="file"
                                            placeholder="Silahkan Pilih File" accept=".xls, .xlsx">
                                        <button type="submit"
                                            class="btn mt-3 btn-primary waves-effect waves-light">Import</button>
                                        <div class="form-group mt-4">
                                            <h6 class="card-title">Unduh Contoh File</h6>
                                            <a href="{{ asset('file/contoh-alokasi-shu.xlsx') }}" class="text-success"><i
