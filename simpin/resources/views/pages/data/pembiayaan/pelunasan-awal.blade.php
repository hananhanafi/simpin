...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Pelunasan Awal</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Data</a></li>
                    <li class="breadcrumb-item">Pembiayaan</li>
                    <li class="breadcrumb-item active">Pelunasan Awal</li>
                </ol>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">Pelunasan Awal</h4>
                        <p class="card-title-desc">Form Pelunasan Awal.</code>.</p>
                    </div>
                    <div class="col-md-6">
