                ...
                <form action="{{ route('data.anggota.store') }}" method="POST" id="form-tambah">
                    <div class="row">
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Gaji</label>
                                <div class="col-sm-9">
                        ...
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Status E-Banking</label>
                                <div class="col-sm-9">
