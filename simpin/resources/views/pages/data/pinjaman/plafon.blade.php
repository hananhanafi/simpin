                    ...
                    <div class="row">
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="no_anggota" class="form-control" id="no_anggota" placeholder="No Anggota" required data-parsley-required-message="Nama Anggota Harus Diisi" value="{{ old('nama') }}" readonly onload="pagePlafon(0,0)">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Nama
                                    Anggota<small class="text-danger">*</small></label>
                                <div class="col-sm-7">
                                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Anggota" required data-parsley-required-message="Nama Anggota Harus Diisi" value="{{ old('nama') }}" readonly onload="pagePlafon(0,0)">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Masa
                                    Kerja</label>
                                <div class="col-sm-7">
                                    <input type="number" name="masa_kerja" class="form-control" id="masa_kerja" placeholder="Masa Kerja (Tahun)" value="{{ old('masa_kerja') }}" onkeydown="pagePlafon(0,0)">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="gaji_pokok" class="form-control" id="gaji_pokok" placeholder="Gaji Pokok" required value="{{ old('gaji_pokok') }}" onkeyup="pagePlafon(this.value,0)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pb-3 col-md-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="jml_pengajuan_baru" class="form-control" id="jml_pengajuan_baru" placeholder="Jumlah Pengajuan Baru" required data-parsley-required-message="Jumlah Pengajuan Harus Diisi" value="{{ old('jml_pengajuan_baru') }}" onkeyup="pagePlafon(0,0)">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="bulan" class="form-control" id="bulan" placeholder="Jumlah Bulan" required data-parsley-required-message="Jumlah Bulan Harus Diisi" value="{{ old('bulan') }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Angsuran<small class="text-danger">*</small></label>
                                <div class="col-sm-7">
                                    <input type="text" name="angsuran" class="form-control" id="angsuran" placeholder="Angsuran" required data-parsley-required-message="Angsuran Harus Diisi" value="{{ old('angsuran') }}" onkeyup="pagePlafon(0,0)">
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        console.log(pilihAnggota);
        
        function plafonSimulasi(no_anggota, bunga, bulan, saldo, bunga_efektif) {
    ...
    function pagePlafon(gaji = 0, no_anggota = 0) {
        ...
        // console.log(jml_pengajuan_baru);
