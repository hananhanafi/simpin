...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Pencairan Pinjaman</h4>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">Pencairan Pinjaman</h4>
                        <p class="card-title-desc">Form Pengecekan Pencairan Pencairan.</code>.</p>
                    </div>
                    <div class="col-md-6">
