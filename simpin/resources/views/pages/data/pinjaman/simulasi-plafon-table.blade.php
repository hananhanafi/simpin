        ...
        @else
            ...
            <div class="row">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="width:60%;padding:0.2rem">Rp.
                                    {{ number_format($request->gaji, 0, ',', '.') }}</th>
                            </tr>
                            <tr>
                ...
                <div class="col-md-2 text-right">
                    <a href="javascript:unduhSimulasi('{{ $anggota->no_anggota }}','{{ $request->masa }}','{{ $request->gaji }}','{{ $request->bulan }}','{{ $request->jml_pengajuan_baru }}','{{ $angsuran }}')"
                        class="btn btn-success"><i class="fa fa-download"></i> Unduh Hasil </a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <table class="table table-borderless">
                        @php
                            $persen = ($ntotalAngsuran / $request->gaji) * 100;
                        @endphp
                        <thead>
                            <tr>
                                <th colspan="3">
