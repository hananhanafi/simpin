...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Data Aktivasi SHU</h4>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">List Data Aktivasi SHU</h4>
...
<form id="aproval-form" method="post">
    @csrf
    <input type="hidden" name="id_shu" id="id_shu">
</form>
@endsection
        ...
        <div class="modal-content">
            <form action="{{ route('approval.shu.approve') }}" method="POST" id="post-approve">
                ...
                <div class="modal-body">
                    <input type="hidden" name="id_shu" id="id-shu">
