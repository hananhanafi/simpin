    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Data Aktivasi Simpanan</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h4 class="card-title">List Data Aktivasi Simpanan</h4>
            ...
            <div class="modal-content">
                <form action="{{ route('approval.simpanan.approve') }}" method="POST" id="post-approve">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Form Approval Simpanan</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="id_simpanan" id="id-simpanan">
