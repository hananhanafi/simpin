...
@section('title')
    Data Simpanan Simpanan Sukarela Berjangka (SSB)
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Data Simpanan Simpanan Sukarela Berjangka (SSB)</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Data</a></li>
                        <li class="breadcrumb-item active">Simpanan Simpanan Sukarela Berjangka (SSB)</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h4 class="card-title">List Data Simpanan Simpanan Sukarela Berjangka (SSB)</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 col-12">
                            Tanggal<br>
                            <input type="date" name="start_date" class="form-control" id="start_date" placeholder="Tanggal Lahir" value="{{ date('Y-m-d') }}" onchange="ssb()">
                        </div>
                        <div class="col-12 my-2">
                        </div>
                        <div class="col-md-4 col-12">
                            Sampai<br>
                            <input type="date" name="end_date" class="form-control" id="end_date" placeholder="Tanggal Lahir" value="{{ date('Y-m-d') }}" onchange="ssb()">
                        </div>
