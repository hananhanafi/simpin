            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-md-4 col-12">
                        Tanggal<br>
                        <input type="date" name="start_date" class="form-control" id="start_date" placeholder="Tanggal Lahir" value="{{ date('Y-m-d') }}" onchange="anggota()">
                    </div>
                    <div class="col-12 my-2">
                    </div>
                    <div class="col-md-4 col-12">
                        Sampai<br>
                        <input type="date" name="end_date" class="form-control" id="end_date" placeholder="Tanggal Lahir" value="{{ date('Y-m-d') }}" onchange="anggota()">
                    </div>
