        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">Form Edit Data Sumber Dana Simpanan dan Pinjaman</h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('master.sumber-dana.update', $id) }}" method="POST" id="form-tambah">
                    <div class="row">
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" id="kode" placeholder="Kode Sumber Dana" required required data-parsley-required-message="Kode Sumber Dana Harus Diisi" value="{{ $sumberdana->kode }}">
                                </div>
                            </div>
                            <div class="row mb-2">
