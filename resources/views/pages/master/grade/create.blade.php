        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">Form Tambah Data Grade Anggota Simpanan dan Pinjaman</h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('master.grade.store') }}" method="POST" id="form-tambah">
                    <div class="row">
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" id="kode" placeholder="Kode Grade Anggota" required required data-parsley-required-message="Kode Grade Harus Diisi" value="{{ old('kode') }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Nama Grade<small class="text-danger">*</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="grade_name" class="form-control" id="grade_name" placeholder="Nama Grade Anggota" required required data-parsley-required-message="Nama Grade Harus Diisi" value="{{ old('grade_name') }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Simpanan Pokok<small class="text-danger">*</small></label>
                                <div class="col-sm-9">
                                    <input type="number" name="simp_pokok" class="form-control" id="simp_pokok" placeholder="Simpanan Pokok" required required data-parsley-required-message="Simpanan Pokok Harus Diisi" value="{{ old('simp_pokok') }}">
                                </div>
                            </div>
                            <div class="row mb-2">
