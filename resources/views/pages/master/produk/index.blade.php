        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">List Data Produk Simpanan dan Pinjaman</h4>
                        <p class="card-title-desc">Data berasal dari Sumber yang tersimpan dalam database</code>.</p>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ route('master.produk.create') }}" class="btn btn-info btn-sm" style="float: right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                        ...
                        <a href="{{ route('export.master_produk') }}" class="btn btn-info btn-sm" style="float: right;margin:0 2px"><i class="fa fa-download"></i> Download Xls</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
@section('footscript')
    ...
    <script>
        ...
        function hapus(uuid){
            var url = '{{ route("master.produk.index") }}/' + uuid;
...
<div id="modal-import" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('master.produk.importXlsProses') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group mb-4">
                        ...
                        <a href="{{ asset('file/contoh-product.xls') }}" class="text-success"><i class="fa fa-download"></i> Unduh</a>
                    </div>
