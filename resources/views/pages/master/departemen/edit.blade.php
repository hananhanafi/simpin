        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">Form Edit Data Departemen Simpanan dan Pinjaman</h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('master.departemen.update', $id) }}" method="POST" id="form-tambah">
                    <div class="row">
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" id="kode" placeholder="Kode Departemen" required required data-parsley-required-message="Kode Departemen Harus Diisi" value="{{ $departemen->kode }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Nama Departemen<small class="text-danger">*</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="departemen" class="form-control" id="departemen" placeholder="Nama Departemen" required required data-parsley-required-message="Nama Departemen Harus Diisi" value="{{ $departemen->departemen }}">
                                </div>
                            </div>
                            <div class="row">
