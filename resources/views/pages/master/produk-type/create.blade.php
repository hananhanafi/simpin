...
@section('title')
    Tambah Data Master Produk Type
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">Form Tambah Data Produk Type Simpanan dan Pinjaman</h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('master.produk-kategori.store') }}" method="POST" id="form-tambah">
                    <div class="row">
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" id="kode" placeholder="Kode Produk Type" required required data-parsley-required-message="Kode Produk Type" value="{{ old('kode') }}">
                                </div>
                            </div>
                            <div class="row mb-2">
