...
@section('title')
    Tambah Data Master Profit Center
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-title">Form Tambah Data Profit Center Simpanan dan Pinjaman</h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('master.profit.store') }}" method="POST" id="form-tambah">
                    <div class="row">
                        <div class="pb-3 col-md-12">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="kode" class="form-control" id="kode" placeholder="Kode Profit Center" required required data-parsley-required-message="Kode Profit Center Harus Diisi" value="{{ old('kode') }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Profit Center" required required data-parsley-required-message="Nama Profit Center Harus Diisi" value="{{ old('nama') }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <label for="horizontal-firstname-input" class="col-sm-2 col-form-label">Keterangan<small class="text-danger">*</small></label>
                                <div class="col-sm-9">
                                    <textarea name="desc" class="form-control" id="desc" placeholder="Keterangan" value="{{ old('desc') }}"></textarea>
                                </div>
                            </div>
                            <div class="row">
