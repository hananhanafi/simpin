            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('data.simpanan.index') }}" class="btn btn-info btn-sm" style="float: right"><i
                    ...
                    <form action="{{ route('data.simpanan.store') }}" method="POST" id="form-tambah">
                        <div class="row">
                            <div class="pb-3 col-md-5">
                                @csrf
                                <div class="row mb-3">
                                    <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">No Anggota<small
                                            class="text-danger">*</small></label>
                                    <div class="col-sm-8">
                                        <select class="form-control select2" style="width: 100%;" name="no_anggota"
                                            id="no_anggota" onchange="pilihAnggota(this.value)">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="nama" class="form-control" id="nama"
                                            ...
                                            data-parsley-required-message="Nama Anggota Harus Diisi"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="saldo_minimal" class="form-control" id="saldo_minimal"
                                            ...
                                            data-parsley-required-message="Jumlah Simpanan Harus Diisi"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="jumlah_bunga" class="form-control" id="jumlah_bunga"
                                            placeholder="Bunga P.A (%)" required
                                            data-parsley-required-message="Jumlah Bunga P.A Harus Diisi"
                                ...
                                <input type="hidden" name="jumlah_bunga_efektif" class="form-control"
