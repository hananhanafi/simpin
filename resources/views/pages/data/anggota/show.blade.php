            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('data.anggota.index') }}" class="btn btn-info btn-sm"
                                style="float: right;margin-left:5px;"><i class="fa fa-chevron-left"></i> Kembali</a>
                            <a href="{{ route('data.anggota.edit', $id) }}" class="btn btn-primary btn-sm"
                            ...
                            <table id="table" class="table table-striped table-bordered no-wrap">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="70%"><?php echo $anggota->grade_nama; ?> (Rp.
                                            {{ number_format($anggota->grades->simp_pokok ?? '0') }})</td>
                                    </tr>
                                    <tr>
                                    ...
                                    @else
                                        @foreach ($anggota->simpananAnggota as $no => $item)
                                            <tr>
                                                ...
                                                <td class="text-right">Rp.
                                                    {{ number_format($item->setoran_per_bln, 0, ',', '.') }}</td>
                            ...
                            <table id="table" class="table table-striped table-bordered no-wrap">
                                ...
                                <tbody>
                                    @if (count($anggota->pembiayaanAnggota) == 0)
                                        <tr>
                                            <td colspan="7" class="text-center"><i>Data Pembiayaan Belum Tersedia</i>
                                            </td>
                                        </tr>
                                    @else
                                        @foreach ($anggota->pembiayaanAnggota as $no => $item)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $item->jenis_pembiayaan }}</td>
                                                <td class="text-right">Rp.
                                                    {{ number_format($item->saldo_akhir_pokok, 0, ',', '.') }}</td>
