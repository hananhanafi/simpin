...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Master Data Pelunasan Baru</h4>
                ...
                <form action="{{ route('data.pinjaman.store') }}" method="POST" id="form-tambah">
                    <div class="row">
                        ...
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Sisa Hutang</label>
                                <div class="col-sm-4">
                                    <input type="text" name="admin_bank" class="form-control" id="admin_bank" placeholder="Sisa Hutang" value="{{ old('admin_bank') }}">
                                </div>
                            </div>
