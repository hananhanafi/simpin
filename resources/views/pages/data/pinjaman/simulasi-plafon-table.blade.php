    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-2 text-right">
                <a href="javascript:unduhSimulasi('{{ $anggota->no_anggota }}','{{ $request->masa }}','{{ $request->gaji }}','{{ $request->bulan }}','{{ $request->jml_pengajuan_baru }}','{{ $angsuran }}')" class="btn btn-success"><i class="fa fa-download"></i> Unduh Hasil </a>
            </div>
        </div>
