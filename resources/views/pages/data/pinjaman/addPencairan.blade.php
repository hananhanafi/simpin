...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Master Data Pencairan Baru</h4>
                ...
                <form action="{{ route('data.pinjaman.store') }}" method="POST" id="form-tambah">
                    <div class="row">
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Tanggal Pencairan</label>
                                <div class="col-sm-7">
                                    <input type="date" name="tgl_pencairan" class="form-control" id="tgl_pencairan" placeholder="Tanggal Pencairan" value="{{ old('tgl_pencairan') }}">
                                </div>
                            </div>
                        ...
                        <div class="pb-3 col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Pelunasan</label>
                                <div class="col-sm-4">
                                    <input type="text" name="asuransi" class="form-control" id="asuransi" placeholder="Pelunasan" value="{{ old('asuransi') }}">
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Dana Ditahan</label>
                                <div class="col-sm-4">
                                    <input type="text" name="asuransi" class="form-control" id="asuransi" placeholder="Dana Ditahan" value="{{ old('asuransi') }}">
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Total Pencairan</label>
                                <div class="col-sm-4">
                                    <input type="text" name="asuransi" class="form-control" id="asuransi" placeholder="Total Pencairan" value="{{ old('asuransi') }}">
                                </div>
                            </div>
                        </div>
                    </div>
