...
class SimulasiSsbRollover implements FromView, WithTitle, ShouldAutoSize
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('pages.data.simpanan.xls.simulasi-ssb-rollover')
                        ->with('bulan', $bulan)
                        ->with('saldo', $saldo)
                        ->with('produk', $produk)
    ...
    {
        return 'Simulai Simpanan SSB Rollover';
    }
}