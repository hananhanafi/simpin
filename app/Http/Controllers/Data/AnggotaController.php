...
class AnggotaController extends Controller
{
    ...
    public function store(RequestAnggota $request)
    {
        try {
            ...
            $anggota->nama_keluarga          = $request->nama_keluarga;
            $anggota->nama_anak              = $request->nama_anak;
            $anggota->nik                    = $request->ktp;
            $anggota->no_kk                  = $request->no_kk;
            $anggota->noka_bpjs              = $request->noka_bpjs;
            $anggota->tmp_lahir              = $request->tmp_lahir;
            $anggota->tmp_lahir_keluarga     = $request->tmp_lahir_keluarga;
            $anggota->tmp_lahir_anak         = $request->tmp_lahir_anak;
            $anggota->tgl_lahir              = $request->tgl_lahir;
            $anggota->tgl_lahir_keluarga     = $request->tgl_lahir_keluarga;
            $anggota->tgl_lahir_anak         = $request->tgl_lahir_anak;
